...
public class employeeFrame extends javax.swing.JFrame {
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(Box1, 0, 477, Short.MAX_VALUE)
                                    .addComponent(t6))))))
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        try {
            ...
            String qur ="insert into company.\"EMPLOYEE\" values("+this.t4.getText()+",'"+this.t1.getText()+"','"+this.t2.getName()+"','"+this.t3.getText()+"','"+this.Box1.getName()+"','"+t7.getText()+"',"+this.t5.getText()+","+this.t6.getText()+",'"+this.t8.getText()+"')";
